...
return [
    ...
    'checks' => [
        ...
        'apache' => App\MyChecks\Apache::class,
        'memory' => App\MyChecks\MemoryUsage::class,
        'cpu' => App\MyChecks\CPUUsage::class,
    ],
    ...
    /*
     * Thresholds for cpu space's alert.
     */
    ...
    /*
     * Thresholds for memory usage's alert.
     */
